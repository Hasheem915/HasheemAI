...
# Optional: suppress MediaPipe warnings
...
def detect_gesture(hand, handedness):
    ...
    fingers = []
    tips = [mp_hands.HandLandmark.INDEX_FINGER_TIP, mp_hands.HandLandmark.PINKY_TIP]
    ...
    return "scroll_up" if sum(fingers) == 3 else "scroll_down" if len(fingers) == 0 else "none"
