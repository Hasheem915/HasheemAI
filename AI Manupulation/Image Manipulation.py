...
image_path = r"C:\Users\farya\OneDrive\Desktop\AI Codigal\AI Manupulation\ev-22_1.webp"
...
cv2.arrowLine(image_rgb, arrow_start, arrow_end, (255, 255, 0), 3, tipLength=0.05)
cv2.arrowLine(image_rgb, arrow_end, arrow_start, (255, 255, 0), 3, tipLength=0.05)
...
plt.title("Annotated image with Region, Centers, and Bi-Directional Height Arrow")
plt.axis("off")
plt.show()
